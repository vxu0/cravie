...
import "./data/category-weights.json";
import "./data/foods-savory.json";
import "./data/foods-sweet.json";
import "./data/savory-categorized.json";
import "./data/sweet-categorized.json";
